...
//          <button className="mt-4 bg-lime-600 text-white py-3 px-8 rounded-lg">
//           Complete Ride
//         </button>
//    </div>
//    <div ref={finishRidePanelRef} className='fixed w-full z-10 bottom-0 translate-y-full bg-white p-3 py-6 pt-12'>
