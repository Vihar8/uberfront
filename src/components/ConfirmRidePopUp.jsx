...
//        className='bg-[#eee] px-6 py-4 font-mono rounded-lg w-full mt-5'
//        type='text' placeholder='Enter OTP' />
//       <button
      
//        className="w-full text-lg mt-5 flex justify-center bg-lime-600 text-white p-3 rounded-lg">
//           Confirm
//         </button>
//         <button onClick={() => {
//             props.setConfirmRidePopupPanel(false)
//             props.setRidePopupPanel(false)
//         }} className="w-full text-lg mt-4 bg-red-500 text-white p-3 rounded-lg">
//           Cancel
//         </button>
//       </form>
//        </div>
